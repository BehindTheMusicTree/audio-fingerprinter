...
- CI uses repository/environment variables and secrets (e.g. `POOL_DIR_INTERNAL`, `FPCALC_INTERNAL_PATH`). Changing workflow behavior or adding secrets is a maintainer responsibility.
