...
ARG DOCKERIZED_GUNICORN_LOG_DIR
...
ENV APP_IS_DOCKERIZED=true \
    ...
    DOCKERIZED_POOL_DIR=$POOL_DIR \
    FLASK_LOGS_ARE_NEEDED=$FLASK_LOGS_ARE_NEEDED \
    DOCKERIZED_FLASK_LOG_DIR=$FLASK_LOG_DIR \
    ...
    DOCKERIZED_GUNICORN_LOG_DIR=$GUNICORN_LOG_DIR \
