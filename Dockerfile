...
ENV APP_IS_DOCKERIZED=true \
    ...
    DOCKERRIZED_POOL_DIR=$POOL_DIR \
    FLASK_LOGS_ARE_NEEDED=$FLASK_LOGS_ARE_NEEDED \
    DOCKERRIZED_FLASK_LOG_DIR=$FLASK_LOG_DIR \
    ...
    DOCKERRIZED_GUNICORN_LOG_DIR=$GUNICORN_LOG_DIR \
